...
export default class App extends Component<Props> {
  state = {
    ...
    speechRate: 0.5,
    speechPitch: 1,
    text: " Why do you confuse yourselves by worrying? Leave the care of your affairs to me and everything will be peaceful. I say to you in truth that every act of true, blind, complete surrender to me produces the effect that you desire and resolves all difficult situations."
  };
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <Button title={`Stop`} onPress={this.stopText} />
